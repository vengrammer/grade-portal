            ...
            <header>
                <div className="flex items-center justify-between px-4 py-2 bg-[#4784ff] text-white ">
                    <div className="flex items-center">
                        ...
                        <h1 className="lg:text-2xl whitespace-nowrap font-bold">Grade Portal</h1>
                    </div>
                    <div className="flex lg:gap-5 lg:pr-10 gap-2">
                    <button className="lg:px-5 px-2 whitespace-nowrap  bg-[#0a6af9] border rounded-sm ">Log in</button>
                        <button className="md:px-5 px-2 whitespace-nowrap  bg-[#078b8b] rounded-sm ">About Us</button>
                    </div>
                </div>
            </header>
            <div className=" flex-1 flex w-full h-full items-center justify-center p-5">
